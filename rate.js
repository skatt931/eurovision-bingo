...
// ============================================================
const PERFORMERS = [
  { country: "🇨🇭 Швейцарія", song: "Host" },
  { country: "🇩🇪 Німеччина", song: "—" },
  { country: "🇫🇷 Франція", song: "—" },
  { country: "🇮🇹 Італія", song: "—" },
  { country: "🇪🇸 Іспанія", song: "—" },
  ...
  { country: "🇩🇰 Данія", song: "—" },
  { country: "🇮🇸 Ісландія", song: "—" },
  { country: "🇮🇱 Ізраїль", song: "—" },
  { country: "🇦🇲 Вірменія", song: "—" },
  { country: "🇬🇪 Грузія", song: "—" },
  { country: "🇦🇿 Азербайджан", song: "—" },
  { country: "🇵🇱 Польща", song: "—" },
  { country: "🇱🇹 Литва", song: "—" },
  { country: "🇱🇻 Латвія", song: "—" },
  { country: "🇪🇪 Естонія", song: "—" },
  { country: "🇳🇱 Нідерланди", song: "—" },
  { country: "🇧🇪 Бельгія", song: "—" },
  { country: "🇦🇹 Австрія", song: "—" },
  { country: "🇮🇪 Ірландія", song: "—" },
  { country: "🇬🇷 Греція", song: "—" },
  { country: "🇨🇾 Кіпр", song: "—" },
];
